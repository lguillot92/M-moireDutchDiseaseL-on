...
merge 1:m customs_region year using ExportationsManufacturés
drop if _merge != 3
drop if export_import=="Imports"
...
gen lexp=log(exptot)
xtreg lexp lreexp (p1-p10)#c.lreexp, fe
xtreg lexp lreexp (p1-p10)#c.lreexp, re
xtreg exptot reexptot (p1-p10)#c.reexp, fe
